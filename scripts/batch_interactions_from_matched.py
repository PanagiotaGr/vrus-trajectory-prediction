...
def main():
    parser = argparse.ArgumentParser(description="Batch interaction analysis for all samples")
    ...
    matched_sample_ids = {r["sample_id"] for r in matched_rows}
    for row in all_rows:
        if row["sample_id"] in matched_sample_ids:
            continue
